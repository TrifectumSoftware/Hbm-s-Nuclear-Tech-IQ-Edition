...
public class RenderPress extends TileEntitySpecialRenderer {
	...
	public void renderTileEntityAt(TileEntity tileentity, double x, double y, double z, float f) {
		GL11.glPushMatrix();
			...
			this.bindTexture(ResourceManager.steam_press_tex);

			ResourceManager.steam_press.renderPart("base");
	...
	public void renderTileEntityAt2(TileEntity tileEntity, double x, double y, double z, float f) {
		GL11.glPushMatrix();
			...
			GL11.glTranslated(0, MathHelper.clamp_double((1D - p), 0D, 1D) * 1.9D, 0);

			this.bindTexture(ResourceManager.steam_press_tex);

			ResourceManager.steam_press.renderPart("press_head");
