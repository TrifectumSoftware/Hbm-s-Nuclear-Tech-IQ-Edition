...
public class RenderSpelunkingDrone extends Render {
	...
	public void doRender(Entity entity, double x, double y, double z, float f0, float f1) {
		...
		this.bindTexture(ResourceManager.delivery_drone_spelunker_tex);
	...
	protected ResourceLocation getEntityTexture(Entity entity) {
		return ResourceManager.delivery_drone_spelunker_tex;
	}
}
