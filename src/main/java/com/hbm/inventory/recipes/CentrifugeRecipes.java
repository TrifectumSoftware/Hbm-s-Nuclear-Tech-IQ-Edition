...
public class CentrifugeRecipes extends SerializableRecipe {
	...
	public void registerDefaults() {
		...
		recipes.put(new OreDictStack("crystalPhosphorus"), new ItemStack[] { new ItemStack(ModItems.powder_fire, 3), new ItemStack(ModItems.powder_fire, 3), new ItemStack(ModItems.ingot_phosphorus, 2), new ItemStack(Items.blaze_powder, 2) });
