...
public class MachineHaemodialysis extends BlockDummyable implements ITooltipProvider {

	public MachineHaemodialysis(Material mat) {
		super(mat);
	}

	@Override
	public TileEntity createNewTileEntity(World world, int meta) {
		if(meta >= 12) return new TileEntityMachineHaemodialysis();
