...
public class ToolRecipes {
	...
	public static void register() {
		...
		CraftingManager.addRecipeAuto(new ItemStack(ModItems.meteorite_sword[0], 1), new Object[] { " B ", "BIB", " S ", 'B', ModItems.blade_meteorite, 'I', ModItems.ingot_meteorite_forged, 'S', KEY_STICK });
		CraftingManager.addRecipeAuto(new ItemStack(ModItems.meteorite_pickaxe[0], 1), new Object[] { "BIB", " S ", " S ", 'B', ModItems.blade_meteorite, 'I', ModItems.ingot_meteorite_forged, 'S', KEY_STICK });
		CraftingManager.addRecipeAuto(new ItemStack(ModItems.meteorite_axe[0], 1), new Object[] { "BI ", "BS ", " S ", 'B', ModItems.blade_meteorite, 'I', ModItems.ingot_meteorite_forged, 'S', KEY_STICK });
		CraftingManager.addRecipeAuto(new ItemStack(ModItems.meteorite_shovel[0], 1), new Object[] { "BI ", " S ", " S ", 'B', ModItems.blade_meteorite, 'I', ModItems.ingot_meteorite_forged, 'S', KEY_STICK });
		CraftingManager.addRecipeAuto(new ItemStack(ModItems.meteorite_hoe[0], 1), new Object[] { "BI ", " S ", " S ", 'B', ModItems.blade_meteorite, 'I', ModItems.ingot_meteorite_forged, 'S', KEY_STICK });
