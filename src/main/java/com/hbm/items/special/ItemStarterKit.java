...
public class ItemStarterKit extends Item {
	...
	public ItemStack onItemRightClick(ItemStack stack, World world, EntityPlayer player) {
		...
		if(this == ModItems.nuke_starter_kit)
		{
			...
			player.inventory.addItemStackToInventory(filledSyringe(ModItems.syringe, Fluids.RADAWAY));
			player.inventory.addItemStackToInventory(filledSyringe(ModItems.syringe, Fluids.RADAWAY));
			player.inventory.addItemStackToInventory(filledSyringe(ModItems.syringe, Fluids.RADAWAY));
			player.inventory.addItemStackToInventory(filledSyringe(ModItems.syringe, Fluids.RADAWAY));
			player.inventory.addItemStackToInventory(filledSyringe(ModItems.syringe, Fluids.RADAWAY));
			...
			player.inventory.addItemStackToInventory(filledSyringe(ModItems.syringe, Fluids.RADAWAY));
			player.inventory.addItemStackToInventory(filledSyringe(ModItems.syringe, Fluids.RADAWAY));
			player.inventory.addItemStackToInventory(filledSyringe(ModItems.syringe, Fluids.RADX));
			player.inventory.addItemStackToInventory(filledSyringe(ModItems.syringe, Fluids.RADX));
